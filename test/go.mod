module github.com/metal3-io/ip-address-manager/test
...
replace (
	...
	github.com/metal3-io/ip-address-manager/api => ../api
)

// Exclude the old standalone cluster-api test framework module to avoid ambiguous imports
exclude sigs.k8s.io/cluster-api/test/framework v0.0.0-20200304170348-97097699f713
